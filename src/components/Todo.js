...
class Todo extends Component {
    ...
    starIcon (){
      ...
      return ( <a href="javascript:"
                  ...
                  className={classNames({ 'ctrlIcon-stared': this.props.star},'ctrlIcon')}
                  style={style}>
                    <i className={classNames({ 'fa-star-o': !this.props.star , 'fa-star': this.props.star},'fa','fa-1x')}
                      aria-hidden="true"></i>
                </a> );
    }
    ...
    itemText_completed () {
      return (<span>
                  <p className={ classNames({ 'contentText-complete': this.props.completed}, 'contentText' )}>
                    {this.state.text}
                  </p>
              </span> );
    }
    ...
    itemText (){
      return ( <a href="javascript:"
                  ...
                  <p className={ classNames(
                                  { 'contentText-complete': this.props.completed ,
                                    'contentText-hover' : this.state.isIconHovering},
                                    'contentText' )}>
                    {this.state.text}
                  </p>
               </a> );
    ...
    itemToggle_completed() {
      return  (<a href="javascript:"
                  onClick={ this.props.toggleTodo }
                  className={classNames({ 'textIcon-complete': this.props.completed},'textIcon')}>
                  <i className="fa fa-check-circle fa-1x" aria-hidden="true"></i>
                </a>);
    }
    ...
    itemToggle_edit() {
        return (<span className={classNames({ 'complete': this.props.completed},'textIcon')}
                    style={{'color': '#717677'}}>
                  <i className="fa fa-genderless fa-1x" aria-hidden="true"></i>
                </span>)
    }
    ...
    render() {
        ...
        return (
          <li className="list-item" onMouseEnter={this.handleItemHover.bind(this,'enter')} onMouseLeave={this.handleItemHover.bind(this,'leave')}>
              <div className="list-item-content">
                  {itemToggle}
                  {itemText}
              </div>
              <div className="list-item-ctrl">
                  {this.starIcon()}
                  {this.trashIcon()}
              </div>
          </li>
